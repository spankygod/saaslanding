          ...
          <div className="relative z-10">
            ...
            <div className="text-center mt-6">
              ...
              <Link href="https://app.waddlejob.xyz" target="_blank" rel="noopener noreferrer">
                <div className="inline-block bg-gradient-to-r from-violet-500 to-violet-400 text-white hover:from-violet-600 hover:to-violet-500 shadow-lg hover:shadow-xl transition-all duration-300 rounded-full px-6 py-2 text-sm cursor-pointer">
                  Launch App
                </div>
              </Link>
            </div>
